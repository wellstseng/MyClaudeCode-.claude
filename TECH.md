...
│   ├── _atom_index.json                            ← V5 JSON SoT（<!-- atom-breakdown -->79 atoms：core 19 + feedback 10 + 失敗模式 2 + local 48〔World4/Tools10/MemDev27/OS4/Continuity2/Vision1〕<!-- /atom-breakdown -->）
