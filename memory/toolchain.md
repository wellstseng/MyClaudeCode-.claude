...
- Related: failures, decisions-architecture, doc-index-system, feedback_global_install, toolchain-ollama, env-traps
...
- [觀] ollama_client.py: singleton pattern，generate()/chat()/embed() 三個 API
...
- [固] LanceDB（此電腦支援 AVX2，效能穩定）
- [固] GTX 1050 Ti 4GB 同時只能跑一個模型，embedding 和推論需輪替
