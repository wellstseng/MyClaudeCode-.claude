...
│   ├── _atom_index.json                            ← V5 JSON SoT（<!-- atom-breakdown -->74 atoms：core 24 + feedback 10 + 失敗模式 2 + local 38〔World4/Tools8/MemDev20/OS3/Continuity2/Vision1〕<!-- /atom-breakdown -->）
