...
│   ├── _atom_index.json                            ← V5 JSON SoT（<!-- atom-breakdown -->97 atoms：core 39 + feedback 9 + 失敗模式 2 + local 47〔World4/Tools11/MemDev25/OS4/Continuity2/Vision1〕<!-- /atom-breakdown -->）
