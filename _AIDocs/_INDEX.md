...
| 6 | DocIndex-System.md | 全檔系統索引（啟動鏈 + Hook 模組 + <!-- skill-count -->23<!-- /skill-count --> Skills + Tools + Memory <!-- atom-breakdown -->114 atoms：core 50 + feedback 11 + 失敗模式 2 + local 51〔Tools10/MemDev34/OS4/Continuity2/Vision1〕<!-- /atom-breakdown -->） | 啟動鏈, lifecycle, 全檔索引, 檔案清單, 系統索引, realm, local atom |
