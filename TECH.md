...
│   ├── _atom_index.json                            ← V5 JSON SoT（<!-- atom-breakdown -->97 atoms：core 44 + feedback 10 + 失敗模式 2 + local 41〔World4/Tools11/MemDev20/OS3/Continuity2/Vision1〕<!-- /atom-breakdown -->）
