...
sequenceDiagram
    ...
    rect rgba(100, 200, 100, 0.1)
        ...
        note over G,O: V2.4 — 回應知識捕獲 (非同步)<br/>V2.5 — Keyword Boost applied in ranked search
    ...
    note over U,F: ✅ 知識已保存到 atoms + vector DB<br/>✅ Hybrid Search + Keyword Boost (V2.5)<br/>✅ 回應知識自動萃取 (V2.4)<br/>✅ 跨 session 重複知識自動晉升 (V2.4)<br/>✅ 下次 session 自動載入
```
