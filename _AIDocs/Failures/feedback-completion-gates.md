...
- Related: feedback-workflow-discipline, feedback-tooling-reliability, reconcile-render-動畫狀態歸屬陷阱, 自己flag的維護動作直接做完不要反問, handoff-綜觀品質與抗失真寫法, feedback-未實證先別斷言-從根源驗證-先證再修-反退避反冗長, 品質完整性判定須讀完整內容-勿從截斷採樣斷言, 併發-session-共用工作樹-收尾選擇性-staging-勿-git-add-a, 巨檔純機械拆分-carve腳本與驗證盲點
